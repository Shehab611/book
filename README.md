...
<p id="description" style="font-size=50px" >A Flutter Application that displays a list of books and recommended books to the user according to his category selection.</p>
