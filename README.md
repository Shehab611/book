...
<p id="description">A Flutter Application that displays a list of books and recommended books to the user according to his category selection style="font-size: 20px;</p>
